...
public class MediaSelectorTestActivity extends BaseActivity {
...
//                .theme(R.style.picture_QQ_style)//主题样式(不设置为默认样式) 也可参考demo values/styles下 例如：R.style.picture.white.style
                ...
                .setOutputCameraPath("/PlayAndroid/Camera")// 自定义拍照保存路径,可不填
                    ...
                    if (selectList != null && selectList.size() > 0) {
                        for (LocalMedia localMedia : selectList) {
                            ...
                            if (localMedia.isCut()) {
                                ...
                                LogUtils.d("cutPath = " + cutPath);
                            }
                            if (localMedia.isCompressed()) {
                                String compressPath = localMedia.getCompressPath();
                                LogUtils.d("compressPath = " + compressPath);
