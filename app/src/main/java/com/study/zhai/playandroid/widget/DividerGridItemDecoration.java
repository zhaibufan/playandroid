...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecoration(Context context) {
        // 分割线的颜色
        mDivider = new ColorDrawable(context.getResources().getColor(R.color.white));
        // 分割线的宽度
        lineWidth = DpToPxUtils.dp2px(context, 5);
    }
...
//        Log.e("liao", state.toString());
        LogUtils.d(TAG, "getItemOffsets = "+ state.toString());
        boolean b = state.willRunPredictiveAnimations();
        boolean b1 = state.willRunSimpleAnimations();
        LogUtils.d(TAG, "b = " +b +" b1= " + b1);
