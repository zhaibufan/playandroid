...
import com.study.zhai.playandroid.utils.ImageUtil;
 ...
 *      2.背景图片的旋转
 *      3.内部文字
 *      currentAnimationInterpolation是2和3动画的插补器，动画1的插补器是LinearInterpolator
 */
public class CircleCountDownView extends View {
    ...
    // 根据动画执行进度计算出来的插值，用来控制2、3动画效果，建议取值范围为0到1
    ...
    private void init(AttributeSet attrs) {
        ...
        padding = typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_padding, DpToPxUtils.dp2px(MyApplication.getInstance(),5));
        ...
        if (borderWidth > 0) {
            ...
            if (showProgress) {
                ...
                processBlurMaskRadius = typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_processBlurMaskRadius, DpToPxUtils.dp2px(5));
            }
        }


        int circleImgSrc = typedArray.getResourceId(R.styleable.CircleCountDownView_circleImgSrc, R.mipmap.ic_launcher);
        ...
        valueTextPaint.setTextSize(typedArray.getDimensionPixelSize(R.styleable.CircleCountDownView_valueTextSize, DpToPxUtils.dp2px(13)));
        ...
        countDownAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                totalTimeProgress = (initialCountDownValue - currentCountDownValue + animation.getAnimatedFraction()) * 1.0f / initialCountDownValue;
                ...
                LogUtils.e("fraction = " + animation.getAnimatedFraction());
                invalidate();
            }
        });
